...
const ele22plus4=()=>{
  ...
  <div className='ele-container1'>
    <div className='ele-container1-sub1'>
      ...
      <div  className='ele-container1-sub1-text3'>< FontAwesomeIcon icon={faRightLong} />
  ...
  <div className='ele-container8'>
    <div className='ele-container8-sub1'>1st Week - 4th Week</div>
    <div className='ele-container8-sub2'></div>
    
    <div className='ele-container8-sub3'>
    <div className='ele-container8-sub4'>
      <div className='ele-container8-sub3-item1'><div className='ele-container8-sub3-item2'>1</div>
      
      </div>
      <div className='ele-container8-sub3-item3'>Frontend Development Basics</div>
      
    </div>
    {handleplus1 ?(<> <div className='ele-container8-sub3-item4' onClick={firsthandle}>+</div></>):( <> <div className='ele-container8-sub3-item4' onClick={firsthandle}>-</div></>)
  ...
  <div className='ele-container8'>
    <div className='ele-container8-sub1'>5th Week - 8th Week</div>
    <div className='ele-container8-sub2'></div>
    
    <div className='ele-container8-sub3'>
    <div className='ele-container8-sub4'>
      <div className='ele-container8-sub3-item1'><div className='ele-container8-sub3-item2'>2</div>
      
      </div>
      <div className='ele-container8-sub3-item3'>Javascript Fundamentals </div>
      
    </div>
    {handleplus2 ?(<> <div className='ele-container8-sub3-item4' onClick={firsthandle2}>+</div></>):( <> <div className='ele-container8-sub3-item4' onClick={firsthandle2}>-</div></>)
    ...
    <div className='ele-container8-sub5'>
      ...
      <div className='ele-container8-sub5-item2'> 
      <div className='ele-container8-sub5-item3'>Introduction to JavaScript</div>
      <div className='ele-container8-sub5-item3'>Variables, scoping, Data type</div>
      <div className='ele-container8-sub5-item3'>Logic Building</div>
      <div className='ele-container8-sub5-item3'>Strings and Numbers</div>
      <div className='ele-container8-sub5-item3'>Operators and loops</div>
      <div className='ele-container8-sub5-item3'>Functions</div>
      <div className='ele-container8-sub5-item3'>Arrays and Objects</div>
      <div className='ele-container8-sub5-item3'>Data Structures - Stack, Queues, Maps, Sets</div>
      <div className='ele-container8-sub5-item3'>Searching and Sorting Algorithms</div>
      <div className='ele-container8-sub5-item3'>Problem Solving</div>
  ...
  <div className='ele-container8'>
    <div className='ele-container8-sub1'>9th Week - 12th Week</div>
    <div className='ele-container8-sub2'></div>
    
    <div className='ele-container8-sub3'>
    <div className='ele-container8-sub4'>
      <div className='ele-container8-sub3-item1'><div className='ele-container8-sub3-item2'>3</div>
      
      </div>
      <div className='ele-container8-sub3-item3'>Building Websites using JS</div>
      
    </div>
    {handleplus3 ?(<> <div className='ele-container8-sub3-item4' onClick={firsthandle3}>+</div></>):( <> <div className='ele-container8-sub3-item4' onClick={firsthandle3}>-</div></>)
    ...
    <div className='ele-container8-sub5'>
      ...
      <div className='ele-container8-sub5-item2'> 
      <div className='ele-container8-sub5-item3'>Understanding and working with DOM</div>
      <div className='ele-container8-sub5-item3'>Modifying Website Elements with JS</div>
      <div className='ele-container8-sub5-item3'>Developer tools in Browsers</div>
      <div className='ele-container8-sub5-item3'>Prototypes</div>
      <div className='ele-container8-sub5-item3'>Closuress</div>
      <div className='ele-container8-sub5-item3'>Browser Local Storage</div>
      <div className='ele-container8-sub5-item3'>Jquery, Ajax</div>
      <div className='ele-container8-sub5-item3'>Promises</div>
      <div className='ele-container8-sub5-item3'>ES5 vs ES6 vs ES7</div>
      <div className='ele-container8-sub5-item3'>Eventloop in Javascript</div>
  ...
  <div className='ele-container8'>
    <div className='ele-container8-sub1'>13th Week - 16th Week</div>
    <div className='ele-container8-sub2'></div>
    
    <div className='ele-container8-sub3'>
    <div className='ele-container8-sub4'>
      <div className='ele-container8-sub3-item1'><div className='ele-container8-sub3-item2'>4</div>
      
      </div>
      <div className='ele-container8-sub3-item3'>React</div>
      
    </div>
    {handleplus4 ?(<> <div className='ele-container8-sub3-item4' onClick={firsthandle4}>+</div></>):( <> <div className='ele-container8-sub3-item4' onClick={firsthandle4}>-</div></>)
    ...
    <div className='ele-container8-sub5'>
      ...
      <div className='ele-container8-sub5-item2'> 
      <div className='ele-container8-sub5-item3'>React Intro</div>
      <div className='ele-container8-sub5-item3'>Node installation</div>
      <div className='ele-container8-sub5-item3'>Create an app using create-react-app</div>
      <div className='ele-container8-sub5-item3'>Understanding basics of react app</div>
      <div className='ele-container8-sub5-item3'>Understanding JSX</div>
      <div className='ele-container8-sub5-item3'>Understanding virtual DOMS , Single page apps</div>
      <div className='ele-container8-sub5-item3'>React Lifecycle</div>
      <div className='ele-container8-sub5-item3'>States, class components vs functional components</div>
      <div className='ele-container8-sub5-item3'>Event handling, props</div>
      <div className='ele-container8-sub5-item3'>Building forms in React</div>
      <div className='ele-container8-sub5-item3'>Routes</div>
      <div className='ele-container8-sub5-item3'>Conditional Rendering</div>
      <div className='ele-container8-sub5-item3'>Pure Components</div>
      <div className='ele-container8-sub5-item3'>High order components</div>
      <div className='ele-container8-sub5-item3'>Controlled vs Uncontrolled components</div>
      <div className='ele-container8-sub5-item3'>React Hooks</div>
      <div className='ele-container8-sub5-item3'>Redux</div>
      <div className='ele-container8-sub5-item3'>Babel, Webpack</div>
      <div className='ele-container8-sub5-item3'>Axios, Creating a mock server</div>
      <div className='ele-container8-sub5-item3'>SASS overview</div>
      </div>
     </div></>):(<></>)
  ...
  <div className='ele-container8'>
    <div className='ele-container8-sub1'>17th Week - 19th Week</div>
    <div className='ele-container8-sub2'></div>
    
    <div className='ele-container8-sub3'>
    <div className='ele-container8-sub4'>
      <div className='ele-container8-sub3-item1'><div className='ele-container8-sub3-item2'>5</div>
      
      </div>
      <div className='ele-container8-sub3-item3'>NodeJS</div>
      
    </div>
    {handleplus5 ?(<> <div className='ele-container8-sub3-item4' onClick={firsthandle5}>+</div></>):( <> <div className='ele-container8-sub3-item4' onClick={firsthandle5}>-</div></>)
  ...
  <div className='ele-container8'>
    <div className='ele-container8-sub1'>20th Week - 22th Week</div>
    <div className='ele-container8-sub2'></div>
    
    <div className='ele-container8-sub3'>
    <div className='ele-container8-sub4'>
      <div className='ele-container8-sub3-item1'><div className='ele-container8-sub3-item2'>6</div>
      
      </div>
      <div className='ele-container8-sub3-item3'>Database</div>
      
    </div>
    {handleplus6 ?(<> <div className='ele-container8-sub3-item4' onClick={firsthandle6}>+</div></>):( <> <div className='ele-container8-sub3-item4' onClick={firsthandle6}>-</div></>)
    ...
    <div className='ele-container8-sub5'>
      ...
      <div className='ele-container8-sub5-item2'> 
      <div className='ele-container8-sub5-item3'>SQL vs NOSQL</div>
      <div className='ele-container8-sub5-item3'>MongoDB/ DynamoDB overview</div>
      <div className='ele-container8-sub5-item3'>Installing MongoDB</div>
      <div className='ele-container8-sub5-item3'>Connecting and Inserting Data</div>
      <div className='ele-container8-sub5-item3'>Deleting and updating Data</div>
      <div className='ele-container8-sub5-item3'>Understanding CRUD operations</div>
      <div className='ele-container8-sub5-item3'>Understanding Firebase</div>
  ...
  <div className='ele-container8'>
    <div className='ele-container8-sub1'>23th Week - 24th Week</div>
    <div className='ele-container8-sub2'></div>
    
    <div className='ele-container8-sub3'>
    <div className='ele-container8-sub4'>
      <div className='ele-container8-sub3-item1'><div className='ele-container8-sub3-item2'>7</div>
      
      </div>
      <div className='ele-container8-sub3-item3'>Code Review & Deployment</div>
      
    </div>
    {handleplus7 ?(<> <div className='ele-container8-sub3-item4' onClick={firsthandle7}>+</div></>):( <> <div className='ele-container8-sub3-item4' onClick={firsthandle7}>-</div></>)
    ...
    <div className='ele-container8-sub5'>
      ...
      <div className='ele-container8-sub5-item2'> 
      <div className='ele-container8-sub5-item3'>Deploy using Netlify and Github</div>
      <div className='ele-container8-sub5-item3'>Get code review by Software Developers</div>
      <div className='ele-container8-sub5-item3'>Deploy all the projects</div>
  ...
  <div className='ele-container8'>
    <div className='ele-container8-sub1'>25th Week - 28th Week</div>
    <div className='ele-container8-sub2'></div>
    
    <div className='ele-container8-sub3'>
    <div className='ele-container8-sub4'>
      <div className='ele-container8-sub3-item1'><div className='ele-container8-sub3-item2'>8</div>
      
      </div>
      <div className='ele-container8-sub3-item3'>Code Review & Deployment</div>
      
    </div>
    {handleplus8 ?(<> <div className='ele-container8-sub3-item4' onClick={firsthandle8}>+</div></>):( <> <div className='ele-container8-sub3-item4' onClick={firsthandle8}>-</div></>)
  ...
  <div className='ele-container8'>
    <div className='ele-container8-sub1'> 28th Week on wards</div>
    <div className='ele-container8-sub2'></div>
    
    <div className='ele-container8-sub3'>
    <div className='ele-container8-sub4'>
      <div className='ele-container8-sub3-item1'><div className='ele-container8-sub3-item2'>9</div>
      
      </div>
      <div className='ele-container8-sub3-item3'>Interviews Opportunities</div>
      
    </div>
    {handleplus9 ?(<> <div className='ele-container8-sub3-item4' onClick={firsthandle9}>+</div></>):( <> <div className='ele-container8-sub3-item4' onClick={firsthandle9}>-</div></>)
    ...
    <div className='ele-container8-sub5'>
      ...
      {/* <div className='ele-container8-sub5-item2'> 
      <div className='ele-container8-sub5-item3'>HTML Blog Page</div>
      <div className='ele-container8-sub5-item3'>ToDo App</div>
      <div className='ele-container8-sub5-item3'>Reminder Clock App</div>
      <div className='ele-container8-sub5-item3'>React Blog Web App</div>
      <div className='ele-container8-sub5-item3'>Portfolio Building</div>
      <div className='ele-container8-sub5-item3'>Ecommerce Web App(Major Project)</div>
      <div className='ele-container8-sub5-item3'>Online Assessement Platform(Major Project)</div>
      <div className='ele-container8-sub5-item3'>Resume Building</div>
  ...
  <div className='ele-container13'>
    ...
    <div className='ele-container13-sub1'>
      {handlehide1 ?(<><div className='ele-container13-sub1-item11' >Application</div> </> ):(<><div className='ele-container13-sub1-item1' onClick={handlehide11} >Application</div></>)
         }
      {handlehide2 ?(<><div className='ele-container13-sub1-item12'>Shortlisting</div></>):(<><div className='ele-container13-sub1-item2' onClick={handlehide12}>Shortlisting</div></>)
      }
      {handlehide3 ?(<><div className='ele-container13-sub1-item13' >Free Webinars</div></>):(<><div className='ele-container13-sub1-item3' onClick={handlehide13}>Free Webinars</div></>)
      }
      {handlehide4 ?(<><div className='ele-container13-sub1-item14' >Enrolment</div></>):(<><div className='ele-container13-sub1-item4' onClick={handlehide14} >Enrolment</div></>)
      }
      {handlehide5 ?(<><div className='ele-container13-sub1-item15' >Batch commencement</div></>):(<><div className='ele-container13-sub1-item5' onClick={handlehide15}>Batch commencement</div></>)
      }
      </div>
    
    <div className='ele-container13-sub2'>
    {handlehide1 ?(<><div  className='ele-container13-font'>Application</div>
      <div><FontAwesomeIcon icon={faCheck}/>We are inviting applications for 2023, 2022 & 2021 passouts.</div>
      <div><FontAwesomeIcon icon={faCheck}/>Apply for the next batch by filling up the application form.</div>
      <div><FontAwesomeIcon icon={faCheck}/>Fill all the information correctly.</div>
      <div><FontAwesomeIcon icon={faCheck}/>Any false information will lead to disqualification.</div>
      </>):(<></>)}
      {handlehide2 ?(<><div className='ele-container13-font'>Shortlisting</div>
      <div><FontAwesomeIcon icon={faCheck}/>After you have submitted the application, your application will be reviewed by PrepBytes team.</div>
      <div><FontAwesomeIcon icon={faCheck}/>Candidates meeting the eligibility criteria will be shortlisted and the free webinars link will be shared to them over email.</div>
      
      </>):(<></>)}
      {handlehide3 ?(<><div className='ele-container13-font'>Free Webinars</div>
      <div><FontAwesomeIcon icon={faCheck}/>Attend Free Webinar conducted by expert mentors</div>
      <div><FontAwesomeIcon icon={faCheck}/>Understand the importance of Web Development and pathway to crack Web Development Jobs</div>
      
      </>):(<></>)}
      {handlehide4 ?(<><div className='ele-container13-font'>Enrolment</div>
      <div><FontAwesomeIcon icon={faCheck}/>Students clearing the interview will be provided with admission letters.</div>
      <div><FontAwesomeIcon icon={faCheck}/>Selected students have to sign the offer letter and pay enrolment amount to enrol in the program.</div>
      <div><FontAwesomeIcon icon={faCheck}/>Enrolment Fees is 100% refundable if candidate wants to come out of the program within 7 days.</div>
      
      </>):(<></>)}
      {handlehide5 ?(<><div className='ele-container13-font'>Batch commencement</div>
      <div><FontAwesomeIcon icon={faCheck}/>Batch will be started post enrolment. Classes will be completely live</div>
  ...
  <div className='ele-container14'>
    <div className='ele-container14-text1'>Payment Plans</div>
      ...
      <div className='ele-container14-sub1'>
        ...
        <div className='ele-container14-sub1-text1'>EMI Starting at</div>
  ...
  <div className='ele-container15'>
      <div className='ele-container15-sub'>
        <div className='ele-container15-sub-item1'>
          <img className='ele-container15-sub-item1-imgsize' src='https://s3.ap-south-1.amazonaws.com/www.prepbytes.com/images/homepage/aditya_mentor_background.png' alt='not-loaded'/>
